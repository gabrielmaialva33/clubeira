defmodule Clubeira.Accounts.PasswordResetToken do
  @moduledoc """
  Single-use password reset credential. Only its SHA-256 digest is persisted.
  """
  ...
  schema "user_password_reset_tokens" do
